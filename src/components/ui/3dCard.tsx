...
export const CardContainer: React.FC<CardContainerProps> = ({
  ...
  return (
    <MouseEnterContext.Provider value={[isMouseEntered, setIsMouseEntered]}>
      <div
        className={cn("pt-10 pb-9 flex items-center justify-center", containerClassName)}
        style={{
          perspective: "1000px",
        }}
      >
...
export const CardBody: React.FC<CardBodyProps> = ({ children, className }: CardBodyProps) => {
  return (
    <div
